                ...
                mockMvc.perform(get("/api/movies"))
                                ...
                                .andExpect(content().json(
                                                "[{" +
                                                                ...
                                                                +
                                                                "},{" +
                                                                "\"id\":\"2\",\"title\":\"Inception\",\"director\":\"Christopher Nolan\",\"year\":2010,\"genres\":[\"Sci-Fi\",\"Action\"],\"rating\":\"PG-13\",\"description\":\"A thief steals corporate secrets through dream-sharing technology.\",\"posterUrl\":\"poster_url_here\",\"trailerUrl\":\"trailer_url_here\",\"showtimes\":[\"1:00 PM\",\"4:00 PM\",\"7:00 PM\"]"
                                                                +
                                                                "}]"));
        }
