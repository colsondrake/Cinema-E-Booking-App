        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-12 justify-center mb-6 md:mb-12">
            <div className="col-span-12 lg:col-span-6 lg:col-start-4 text-center">
              ...
              <p className="mb-2">Or Continue as Guest</p>
            </div>
          </div>
          ...
          <div className="max-w-md mx-auto bg-[#17233a] p-6 rounded-xl border border-[#17233a]">
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="flex items-center justify-between mb-4">
                <button type="button" onClick={() => router.push('/booking/checkout')} className="px-6 py-2 bg-blue-600 hover:bg-blue-500 rounded-md cursor-pointer">Continue as Guest</button>
